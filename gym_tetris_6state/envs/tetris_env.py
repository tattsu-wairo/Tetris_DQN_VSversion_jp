...
class TetrisEnv(gym.Env):
    ...
    def __init__(self, action_mode=0):
        ...
        self.observation_space = gym.spaces.Tuple((
            gym.spaces.Discrete(10), # Rows cleared
            gym.spaces.Discrete(10 * 20), # Bumpiness
            gym.spaces.Discrete(10 * 20), # Holes number
            gym.spaces.Discrete(20), # Landing height
            gym.spaces.Discrete(10 * 20), # Row transitions
            gym.spaces.Discrete(10 * 20), # Column transitions
            gym.spaces.Discrete(10 * 20), # Cumulative wells
            gym.spaces.Discrete(4 * 4), # Eroded piece cells
            gym.spaces.Discrete(10 * 20) # Aggregate height
        ))
        """
        self.observation_space = gym.spaces.Tuple((
            gym.spaces.Discrete(20), # landing Height
